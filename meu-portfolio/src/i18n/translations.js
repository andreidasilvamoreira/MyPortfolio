    ...
    pt: {
        ...
        skills: {
            ...
            sections: {
                ...
                practices: "Metodologias e Boas Práticas",
                tools: "Ferramentas"
            }
        },
    ...
    en: {
        ...
        home: {
            description: [
                ...
                "I build fast, secure and scalable APIs using PHP, Laravel, MySQL and React."
            ],
            actions: {
        ...
        skills: {
            ...
            sections: {
                database: "Databases",
                practices: "Methodologies and Best Practices",
                tools: "Tools"
            }
        },
